			...
			<ul id="js-news" class="js-hidden">
				<?php
					foreach ($m as $each) {
						...
						?><li class="news-item"><span style="font-size:8pt;color:orange;font-weight:bold;">&gt;</span> <a href="http://www.minjok.hs.kr/members/" target="_new" style="color:black">
							<?php echo "<b>[$date] $type</b>: $msg" ?></a></li>
				<?php
					}
					?>
				<li></li>
