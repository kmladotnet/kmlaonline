        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <ui-select multiple ng-model="accusedSelect.selectedPeople" theme="bootstrap" ng-disabled="disabled" sortable="true" close-on-select="false">
                                                ...
                                                <ui-select-choices repeat="accused in (accusedArray | filter: $select.search) track by accused.student_id">
                                                    <div ng-bind-html="accused.name"></div>
                                                    <small>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input type="text" class="form-control" uib-datepicker-popup ng-model="accused_date2" is-open="popup" datepicker-options="dateOptions" ng-required="true" close-text="Close">
                    ...
                    <button type="button" class="btn btn-default pull-right" ng-click="submitListofArticle()">테스트 제출</button>
                    <br/>
