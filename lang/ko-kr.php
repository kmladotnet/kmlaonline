...
$_LANGUAGE=array(
	...
	"user"=>array(
		...
		"register"=>array(
			"title"=>"회원가입",
			// "tos"=>"현재 작업 중입니다.",
			"tos"=>"KMLA Online은 민족사관고등학교 동문 간 편리한 소통, 그 외 신원 확인을 목적으로 최소한의 개인정보를 수집합니다. 이는 E-Mail, 이름, 생일 등을 포함합니다. 학번은 선택 사항이지만 추후 본인과 타인의 쉽고 원활한 소통을 위하여 입력하시는 것을 권장드립니다.",
	...
	"layout"=>array(
		...
		"footer"=>'<div style="display: table;/* width: 100%; */margin: auto;width: calc(58% + 320px);"><div style="display: table-cell;text-align: left;">닷넷 2007 - '.date("Y").'</div><div style="display: table-cell;text-align: right;"><img src="/images/kmlaonline-p-resize.png" style="/* display: block; *//* margin: auto; */height: 24px;display: inline-block;/* float: right; */"></div></div>'
	),
    "weather"=>array(
        200 => '뇌우',
        201 => '뇌우',
