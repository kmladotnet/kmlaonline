...
$_LANGUAGE=array(
	...
	"user"=>array(
		...
		"register"=>array(
			"title"=>"회원가입",
			// "tos"=>"현재 작업 중입니다.",
			"tos"=>"KMLA Online은 민족사관고등학교 동문 간 편리한 소통, 그 외 신원 확인을 목적으로 최소한의 개인정보를 수집합니다. 이는 E-Mail, 이름, 생일 등을 포함합니다. <br /> 학번은 선택 사항이지만 추후 본인과 타인의 쉽고 원활한 소통을 위하여 입력하시는 것을 권장드립니다.",
