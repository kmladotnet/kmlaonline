...
function lang($key1, $key2, $key3 = null, $key4 = null)
{
    global $_LANGUAGE;
    if (is_null($key3)) {
        return htmlspecialchars(isset($_LANGUAGE[$key1][$key2]) ? $_LANGUAGE[$key1][$key2] : "$key1 $key2");
    }

    if (is_null($key4)) {
        return htmlspecialchars(isset($_LANGUAGE[$key1][$key2][$key3]) ? $_LANGUAGE[$key1][$key2][$key3] : "$key1 $key2 $key3");
    }
...
function langraw($key1, $key2, $key3 = null, $key4 = null)
{
    global $_LANGUAGE;
    if (is_null($key3)) {
        return isset($_LANGUAGE[$key1][$key2]) ? $_LANGUAGE[$key1][$key2] : "$key1 $key2";
    }

    if (is_null($key4)) {
        return isset($_LANGUAGE[$key1][$key2][$key3]) ? $_LANGUAGE[$key1][$key2][$key3] : "$key1 $key2 $key3";
    }
