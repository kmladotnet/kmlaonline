...
$_LANGUAGE=array(
    ...
    "layout"=>array(
        ...
        "footer"=>'<div style="display: table;/* width: 100%; */margin: auto;width: calc(100%);"><div style="display: table-cell;text-align: left;">닷넷 2007 - '.date("Y").'</div><div style="display: table-cell;text-align: right;"><img src="/images/kmlaonline.png" style="/* display: block; *//* margin: auto; */height: 24px;display: inline-block;/* float: right; */"></div></div>'
    )
);
