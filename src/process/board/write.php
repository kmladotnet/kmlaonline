...
if(count($errors)==0){
	...
	$article_id=$board->addArticle($cat['n_id'], $_POST['s_title'], $s_data, $me['s_name'], ($article_flag & 0x4) ? 0 : $me['n_id'], isset($parent_article)?$parent_article['n_id']:0, 0, $attach, $tag);
	if($article_id===false){
