        ...
        <div class="slidedown" id="slidedown3_sub" style="right:40px;" tabindex="0">
            <form method="get" action="/searchall">
                ...
                <div style="width:100%;overflow:hidden;">
                    <input type="text" name="search" id="txt_search_whole" value="" style="width:100%;border-left:none;border-right:none;border-top:1px solid gray;border-bottom:1px solid gray;" />
                </div>
