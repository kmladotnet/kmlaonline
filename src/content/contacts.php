...
function printContentPc(){
	...
	<div style="padding:10px;" class='contact-finder'>
		<h1><span class="contact-icon" style="vertical-align:middle"></span> <span style="vertical-align:middle">연락처</span></h1>
		<div style="padding-top:10px;">
			...
			<?php } ?>
			<table style="width:100%" class="notableborder">
				<thead>
					<tr style="height:32px;">
						<th style="width:32px;">기수</th>
				...
				<tbody>
					<?php foreach($arr as $m){
						?>
						<tr style="height:32px;">
							<td style="text-align:center"><?php echo $m['n_level']?></td>
							...
							<td style="text-align:center"><?php echo htmlspecialchars($m['s_room'])?></td>
							<td style="text-align:center"><?php echo htmlspecialchars($m['n_student_id'])?></td>
							<td style="text-align:center">
								<?php
								if($m['n_grade'])
							...
							<td style="text-align:center"><?php echo $gender_list[$m['n_gender']] ?></td>
							<td style="text-align:center"><?php if($m['s_phone']!=""){ ?><a href="tel:<?php echo rawurlencode($m['s_phone'])?>"><?php echo htmlspecialchars($m['s_phone'])?></a><?php }else{ ?><span style="color:gray">(없음)</span><?php } ?></td>
							<td style="text-align:center"><?php echo $m['n_birth_date_yr']."년 ".$m['n_birth_date_month']."월 ".$m['n_birth_date_day']."일";?></td>
							<td style="text-align:center"><a href="mailto:<?php echo rawurlencode($m['s_email'])?>"><?php echo $m['s_email']; ?></a></td>
							<td style="text-align:center"><?php if($m['s_homepage']!=""){ ?><a target="_blank" rel="closenow" href="<?php echo htmlspecialchars($m['s_homepage']); ?>"><?php echo htmlspecialchars($m['s_homepage'])?></a><?php }else{ ?><span style="color:gray">(없음)</span><?php } ?></td>
							<td style="text-align:left"><?php echo htmlspecialchars($m['s_status_message']) ?></td>
						</tr>
					<?php } ?>
				</tbody>
			</table>
