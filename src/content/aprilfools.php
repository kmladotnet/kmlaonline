  ...
  <div>
    ...
    <tbody>
        <tr>
            ...
            <td>
                미설치
                <a class="april-link btn btn-danger" href="april-fools/KmlaActiveX.exe">설치하기</a>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                미설치
                <a href="/data/game/gostop.swf" class="april-link btn btn-danger">설치하기</a>
            </td>
        </tr>
        <tr>
...
$("a").not(".april-link").not("".removeAttr("href");
</script>
<?php
}
?>
