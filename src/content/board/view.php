...
<?php
$path = "https://kmlaonline.tk/files/bbs/{$cat['n_id']}/{$article['n_id']}/{$v['n_id']}/{$v['s_key']}/" . rawurlencode($v['s_name']);
            $path_thumb = "https://kmlaonline.tk/files/bbs/{$cat['n_id']}/{$article['n_id']}/{$v['n_id']}/{$v['s_key']}/$thumbmode/" . rawurlencode($v['s_name']);
            $path_force = "https://kmlaonline.tk/files/bbs/{$cat['n_id']}/{$article['n_id']}/{$v['n_id']}/{$v['s_key']}/force/" . rawurlencode($v['s_name']);
            $file_types = array(
