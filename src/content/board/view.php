			...
			<div id="article_comment_sub_<?php echo $comment['n_id']?>" class="new_acomment">
                ...
                <div style="display:block;">
                    ...
                    <?php if($board_id!='picexhibit') { ?>
                        <div <?php if($votes < 0) {
                            echo 'style="color:rgb('.floor(255 * max(0.5, 1 + $votes / 10)),',',floor(255 * max(0.5, 1 + $votes / 10)),',',floor(255 * max(0.5, 1 + $votes / 10)),')!important; font-size:0.9em!important;font-weight:normal!important"';
                        }
                        ?>>
