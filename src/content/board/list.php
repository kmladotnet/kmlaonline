            ...
            ?>
                <tr class="forum_list_item" style="<?php echo (isset($_GET['bitm']) && $_GET['bitm'] == $item['n_id']) ? "font-weight:bold;" : "" ?>">
                    ...
                    <td>
                        ...
                        <div style="display:inline-block">글쓴이: <?php if ($b_anonymous) {
                                                                    echo '익명';
                                                                } else { ?><a href="<?php echo htmlspecialchars(addslashes("/user/view/" . $memb['n_id'] . "/" . $memb['s_id'])) ?>">
                                    <?php putUserCard($memb); ?></a>
                            <?php } ?></div>
...
?>
    ...
    switch ($board_cat['n_viewmode']) {
        case 0:
            ...
            break;
        case 1:
            printArticleListTypeGallery($board_data, $additional_query_string);
            break;
        case 2:
            printArticleListTypeForum($board_data, $additional_query_string);
            break;
    }
    ?>
    ...
    <div style="text-align:center">
        <ul class="pagination">
            ...
            if (!isset($disp[$page_count]) && $page_count > 1) { ?>
                <li <?php if ($pagenumber == $page_count) {
                        echo "class='active'";
                    }
                    ?>>
