...
switch ($board_cat['n_viewmode']) {
        case 0:printArticleListTypeBoard($board_data, $additional_query_string);
            break;
        case 1:printArticleListTypeGallery($board_data, $additional_query_string);
            break;
        case 2:printArticleListTypeForum($board_data, $additional_query_string);
            break;
    }
    ?>
