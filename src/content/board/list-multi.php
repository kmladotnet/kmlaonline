...
function printArticleList(){
	...
	$article_count=$board->getArticleCount($board_id, false, 0, $search, $search_mode_and, $search_submode_and, $search_title, $search_data, $search_tag, $search_writer);
	...
	$board_data=$board->getArticleList($board_id, false, 0, $pagenumber, $articleperpage, $orderby_name, $orderby_desc, $incl_text, $search, $search_mode_and, $search_submode_and, $search_title, $search_data, $search_tag, $search_writer);
	if($search!==false){
