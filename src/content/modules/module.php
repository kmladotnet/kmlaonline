...
$colors = array(
    ...
    foreach ($colors as $k => $v) {
        ?>
                    <option value="<?php echo $k; ?>" <?php if ($options['color'] === $k) {
            echo 'selected';
        }
        ?> >
                        <?php echo $v; ?>
...
foreach ($a[1] as $b) {
                    ?>
                                <option value="<?php echo $b['n_id']; ?>" <?php if (in_array($b['n_id'], $options['cat'])) {
                        echo 'selected';
                    }
                    ?> >
                                    <?php echo $b['s_name']; ?>
...
$shown = array(
            ...
            foreach ($shown as $k => $v) {
                ?>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="<?php echo $k; ?>" <?php if ($options[$k]) {
                    echo 'checked';
                }
                ?>>
                            <?php echo $v; ?> 표시
...
break;
        case 'menu':
            ...
            <div class="checkbox">
                <label>
                    <input type="checkbox" name="all-day" <?php if ($options["all-day"]) {
                echo 'checked';
            }
            ?>>
                    넓은 레이아웃
