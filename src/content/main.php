        ...
        <div class="btn-group" role="group" aria-label="...">
            ...
            foreach(array("everyday_parcel"=>"택배", "everyday_guidance"=>"선도", /*"everyday_honjung"=>"혼정", */"leftover"=>"잔반") as $k=>$v){
                ...
                if(count($a)==0){
                    ...
                    $a=$a[0];
                    echo "<a class='btn ".((time()-$a['n_writedate']<43200) ? 'btn-default':'btn-primary')." everyday-button' role='button' href=\"/board/$k/view/{$a['n_id']}\">{$v} <span>(".date("m월 d일", $a['n_writedate']).")</span></a>";
                }
            }
            ?>
        </div>
