		...
		<script type="text/html" id="article_comment_template">
			<div id="article_comment_write_<%=ARTICLEID%>" class="acomment">
				...
				<form method="post" action="/ajax/board/write" onsubmit="return saveAjax(this,'<?php echo lang("board","article","writing comment")?>');">
					...
					<input type="submit" onsubmit="removeAlertOnLeave();" value="<?php echo lang("board","article","write comment")?>" style="box-sizing: border-box;width:80px;height:32px;float:right;" />
					<input type="button" class="btn" onclick="location.href='<?php echo "/board/$board_id/comment/<%=ARTICLEID%>"; ?>';" value="고급" style="box-sizing: border-box;width:80px;height:32px;float:left;" />
