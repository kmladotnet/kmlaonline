...
<?php echo lang("user","register","accept tos"); ?>
			...
			<table style="margin:20px auto;width:800px;">
				<tr>
					<th style="width:400px;"><h2>
<?php echo lang("user","register","required"); ?></h2></th>
					<th style="width:20px;"></th>
					<th style="width:400px;"><h2>
<?php echo lang("user","register","optional"); ?></h2></th>
				</tr>
				<tr>
...
<?php echo lang("generic","id"); ?></th>
							...
							<tr>
								<th style="width:120px;">
<?php echo lang("generic","password"); ?></th>
								<td>
                                    <div class="form-group">
							...
							<tr>
								<th style="width:120px;">
<?php echo lang("user","register","password check"); ?></th>
								<td>
                                    <div class="form-group">
							...
							<tr>
								<th style="width:120px;">
<?php echo lang("generic","email"); ?></th>
								<td>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <select name="n_wave" class="selectpicker" data-size="5" data-width="100%" style="width:100%">
                                            ...
                                            <?php for($i = $max_level, $j = 0; $i >= 1; $i--, $j++){ ?>
                                                <option value="<?php echo $i?>" <?php echo (isset($_POST['n_wave']) && $_POST['n_wave']==$i)?"selected='selected'":""?>>
<?php echo $i . "기 " . ($j>=3?"졸업생":"학생") ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
								</td>
...
<?php echo lang("generic","nick"); ?></th>
							...
							<tr>
								<th style="width:120px;">
<?php echo lang("generic","birthday"); ?></th>
								<td style="text-align:left">
                                    <div class="form-group">
                                        <input class="form-control" type="number" style="width:80px; display:inline-block" name="n_birth_date_yr" <?php echo isset($_POST['n_birth_date_yr'])?"value='".htmlspecialchars($_POST['n_birth_date_yr'])."'":""?> required/>
<?php echo lang("generic","year"); ?>
                                        <input class="form-control" type="number" style="width:60px; display:inline-block" name="n_birth_date_month" <?php echo isset($_POST['n_birth_date_month'])?"value='".htmlspecialchars($_POST['n_birth_date_month'])."'":""?> required/>
<?php echo lang("generic","month"); ?>
                                        <input class="form-control" type="number" style="width:60px; display:inline-block" name="n_birth_date_day" <?php echo isset($_POST['n_birth_date_day'])?"value='".htmlspecialchars($_POST['n_birth_date_day'])."'":""?> required/>
<?php echo lang("generic","day"); ?>
                                    </div>
								</td>
							</tr>
							<tr>
								<th style="width:120px;">
<?php echo lang("generic","gender"); ?></th>
								<td>
                                    <div class="form-group">
                                        <select name="n_gender" class="selectpicker" data-width="100%" style="width:100%">
                                            ...
                                            foreach($opt_list as $key=>$val){
                                                ?><option value="<?php echo $key?>" <?php echo (isset($_POST['n_gender']) && $_POST['n_gender']==$key)?"selected='selected'":""?>>
<?php echo htmlspecialchars($val)?></option>
<?php
                                            }
                                            ?>
                                        </select>
					...
					<td style="vertical-align:top">
						<table style="width:100%" class="table-register-data">
							<tr>
								<th style="width:120px;">
<?php echo lang("generic","picture")?></th>
								<td><div class="upper-file"><input type="file" name="s_pic" style="width:100%" /><span>
<?php echo lang("generic","choose file")?></span></div></td>
							</tr>
							<tr>
								<th style="width:120px;">
<?php echo lang("generic","icon")?></th>
								<td><div class="upper-file"><input type="file" name="s_icon" style="width:100%" /><span>
<?php echo lang("generic","choose file")?></span></div></td>
							</tr>
							<tr>
								...
								<td style="text-align:left">
                                    <div style="top:-3px;display:inline-block;position:relative;">
                                        <select name="n_grade" class="selectpicker" data-width="90px">
                                            ...
                                            foreach($opt_list as $key=>$val){
                                                ?><option value="<?php echo $key?>" <?php echo (isset($_POST['n_grade']) && $_POST['n_grade']==$key)?"selected='selected'":""?>>
<?php echo htmlspecialchars($val)?></option>
<?php
                                            }
                                            ?>
							...
							<tr>
								<th style="width:120px;">
<?php echo lang("generic","status message")?></th>
							...
							<tr>
								<th style="width:120px;">
<?php echo lang("generic","homepage")?></th>
								<td><input class="form-control" type="text" name="s_homepage" placeholder="e.g. www.facebook.com/your_id" style="width:100%" <?php echo isset($_POST['s_homepage'])?"value='".htmlspecialchars($_POST['s_homepage'])."'":""?> /></td>
							</tr>
							<tr>
								<th style="width:120px;">
<?php echo lang("generic","phone")?></th>
							...
							<tr>
								<th style="width:120px;">
<?php echo lang("generic","interest")?></th>
