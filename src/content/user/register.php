...
function printContent(){ ?>
	...
	<form action="/ajax/user/register" method="post" enctype="multipart/form-data" onsubmit="window.onbeforeunload=null;">
		...
		<div style="text-align:center;width:100%">
			...
			<table style="margin:0 auto;width:740px;" class="notableborder">
				<tr>
					<th style="width:360px;"><h2><?php echo lang("user","register","required"); ?></h2></th>
					<th style="width:20px;"></th>
					<th style="width:360px;"><h2><?php echo lang("user","register","optional"); ?></h2></th>
				</tr>
				<tr>
					<td style="vertical-align:top">
						<table style="width:100%" class="table-register-data">
							...
							<tr>
								...
								<td>
									<select name="n_wave" style="width:100%">
							...
							<tr>
								...
								<td>
									<select name="n_gender" style="width:100%">
										<?php
					...
					<td style="vertical-align:top">
						<table style="width:100%" class="table-register-data">
							...
							<tr>
								...
								<td style="text-align:left">
									<select name="n_grade" style="width:80px">
										<?php
